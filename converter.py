...
def convert(dir_path, sample_rate, n_electrodes):
    ...
    wvf_byc, times_byc, units_byc = add_noise_unit_to_empty_channel(wvf_byc, times_byc, units_byc)  # because kilosort does not accept matlab v7.3 file generated by hdf5storage having empty channel
